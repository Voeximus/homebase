...
export const MOCK_ACTIVITY: ActivityVM = {
  sinceMonday: 1136,
  needsReview: 4,
  ...
  rows: [
    ...
    },
    {
      ...
      amount: 83.0,
      fate: "skip",
      badgeLabel: "Bill · not in budget",
    },
    {
      id: "r4",
      merchant: "SQ *JOHNNY'S",
      catId: "other",
      amount: 18.4,
      fate: "review",
    ...
    {
      id: "r5",
      merchant: "Payroll — Gino",
      catId: "salary",
      amount: 991.0,
      fate: "income",
      badgeLabel: "Income · not in budget",
    },
  ],
};
