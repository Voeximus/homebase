  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "#12100c", border: "1px solid #332b20", borderTop: "2px solid #dab249", borderRadius: "22px", padding: "16px" }}
        onClick={(e) => e.stopPropagation()}
      >
        <div className="mb-3 flex items-start gap-2.5">
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl" style={{ background: "#2a2007", color: "#dab249" }}>
        ...
        {anomalies.length === 0 ? (
          <div className="py-8 text-center">
            <Check size={26} style={{ color: "#39c0b4" }} className="mx-auto" />
          ...
          <div className="flex flex-col gap-2">
            {anomalies.map((a) => {
              ...
              return (
                <div key={a.id} className="rounded-xl p-3" style={{ background: "#1c1811", border: "1px solid #332b20" }}>
                  <button onClick={() => onTxn(a.id)} className="flex w-full items-center gap-3 text-left">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-[11.5px]" style={{ color: "#dab249" }}>
                  ...
                  <div className="mt-2 flex gap-2">
                    <button onClick={() => onTxn(a.id)} className="flex-1 rounded-lg py-2 text-[12.5px] font-semibold" style={{ background: "#223059", color: "#7f9ff7" }}>
                      {t("Recategorize")}
                    </button>
                    <button onClick={() => onDismiss(a.id)} className="flex-1 rounded-lg py-2 text-[12.5px] font-semibold" style={{ background: "#0f1f1c", color: "#39c0b4" }}>
