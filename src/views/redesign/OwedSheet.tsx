  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "#12100c", border: "1px solid #332b20", maxHeight: "86vh" }}
      ...
      >
        <div className="flex items-center justify-between px-5 pb-2 pt-4">
          ...
          <button onClick={onClose} className="rounded-full p-1.5" style={{ background: "#262016" }}>
            <X size={16} style={{ color: "#9e9180" }} />
          </button>
        </div>
        <div className="px-4 pb-6">
          {owed.length === 0 ? (
            <div className="py-8 text-center text-[13px]" style={{ color: "#9e9180" }}>
            ...
            owed.map((o) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="ml-2 text-[15px] font-bold" style={{ color: "#39c0b4" }}>
                    {money2(o.amount)}
                  </div>
                </div>
                {o.suggested ? (
                  ...
                  <button
                    ...
                    style={{ background: "#332b20", color: "#e6dccb", border: "1px solid #453a2b" }}
                  >
                    {t("Possible payback")}:{" "}
            ...
            <>
              ...
              {settled.map((o) => (
                <div
                  ...
                  style={{ background: "#12100c", border: "1px solid #262016" }}
                >
                  <div className="min-w-0">
                    <div className="truncate text-[12.5px]" style={{ color: "#9e9180" }}>{o.merchant}</div>
