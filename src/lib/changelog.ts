...
export const CHANGELOG: Release[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "It won't accept a number until two camera frames agree on it AND the barcode's own built-in checksum passes. A misread doesn't fail loudly — it quietly looks up a different food — so it's worth the extra fifteenth of a second.",
  ...
  },
  {
    ...
    date: "August 18, 2026",
    notes: [
      "Home was showing about $1,000 less available than you actually had, every month — it counted bills that hadn't started yet. Bills and Forecast were right all along.",
      "Closed a security hole that could have let someone outside the household delete your data.",
      "Your phone stops reminding you about bills that aren't due, and rent finally gets its day-before warning.",
      "New: \"Does this add up?\" in Profile — the app checks its own numbers and tells you if they disagree.",
    ],
  },
  {
    version: "2026.08.17a",
