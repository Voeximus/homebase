...
const SEED: Record<string, string> = {
  ...
  "No study notes for this exercise yet.": "这个动作还没有研究笔记。",
  "Show more": "显示更多",
  "Tested on a similar exercise, not this one.": "在类似动作上测试，并非此动作。",
  "Sources ({n})": "来源（{n}）",
  "Tested over weeks": "多周训练研究",
  "Measured in one workout": "单次训练测量",
  "Reasoned, not tested": "推理得出，未经测试",
  ...
  "Minimum band": "最低区间",
  "More growth for each set": "每组带来的增长较多",
